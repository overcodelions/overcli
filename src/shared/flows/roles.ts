...
export function artifactInstruction(outputName: string, allowFileRef = false): string {
  ...
  return [
    ...
    'This block is TEXT IN YOUR REPLY. It is not a file, and emitting it does not create,',
    'write, or edit anything. So it NEVER conflicts with an instruction above telling you to',
