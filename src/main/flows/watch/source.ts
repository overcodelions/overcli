...
function safetyPreamble(ctx: WatchTickContext): string {
  ...
  return [
    ...
    '',
    'TOOLS — your tools may be DEFERRED: a tool can appear in your list but not',
    'be directly callable until you load it (e.g. via a tool-search / load step).',
    'If the tool you need to reach the target is not directly callable, LOAD IT',
    'FIRST and then call it. Do NOT conclude the tool is unavailable until you',
    'have actually tried loading and calling it. Only set "tools_unavailable"',
    'true when, after trying to load it, you genuinely have no working tool that',
