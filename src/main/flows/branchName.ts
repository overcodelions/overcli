...
// launch prompt, so the auto-created branch reads like `feature/ABC-1234`
...
/// trailing digits, a hyphen, and a number — e.g. ABC-1234, ABC2-17, PROJ-9.
...
///      (upper-cased), so "fix ABC-1234" → `ABC-1234`.
