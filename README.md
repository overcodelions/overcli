...
| 21 | **Everyday projects** | Overcli without a repo. Describe what you want and get a prepared folder with `inbox/` and `output/`, an undo history it sets up for you, and starter flows for documents rather than code. See [Everyday projects](docs/everyday-projects.md). |
