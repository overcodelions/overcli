...
| 09 | **File editor** | Tabs, per-file view modes, syntax highlighting, line-range highlighting, HTML & Markdown preview. Open files are remembered per conversation, flow run and explorer root — leave and come back and they're still there. No context-switch to VS Code. |
